...
def draw_hud(surf, score, health, lives, font_big, font_sm):
    ...
    ctrl = font_sm.render("WASD/ARROWS: Move   SPACE: Fire   ESC: Exit", True, (100,100,140))
...
class Bullet:
    def __init__(self, x, y, speed, color, owner):
        ...
        self.speed  = speed
        self.color  = color
        self.owner  = owner   # 1=player, -1=enemy
        self.active = True
...
def main():
    ...
    while True:
        ...
        if state == "playing":
            ...
            # Win condition (score-based for demo)
        ...
        draw_hud(screen, player.score, player.health, player.lives, font_big, font_sm)
